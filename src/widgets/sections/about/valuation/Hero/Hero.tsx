			...
			<div className='container'>
				<div className={styles.wrapper}>
					<div className={styles.content}>
						...
						<MotionBox>
							<h1 className={`${halvar.className} ${styles.title}`}>
								1 церковь —<br /> 1 видение
							</h1>
						</MotionBox>
						<MotionBox delay={0.2}>
							<p className={styles.text}>
								С момента основания нашей церкви в 1995 году мы знали, что
								церковь «Слово жизни» будет большой, богослужения будут
								проходить в разных районах Москвы и области и что независимо от
								количества богослужений и удаленности друг от друга, церковь
								«Слово жизни» будет ОДНОЙ ЦЕРКОВЬЮ.
							</p>
						</MotionBox>
					</div>
