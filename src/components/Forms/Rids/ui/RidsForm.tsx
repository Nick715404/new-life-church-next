      ...
      <form onSubmit={handleSubmit(onSubmit)} className={styles.form}>
        ...
        <label htmlFor="agreement" className={styles.checkboxLabel}>
          ...
          <p>
            ...
            фамилия, электронную почту, номер телефона, церковь, город. Действия
            с персональными данными, на совершение которых дается согласие, как
            с использованием средств автоматизации, так и без таковых: сбор,
