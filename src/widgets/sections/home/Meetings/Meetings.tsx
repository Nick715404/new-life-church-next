					...
					<div className={styles.textContent}>
						...
						<MotionBox delay={0.4} className={styles.textBox}>
							<p className={styles.text}>
								В мире часто бывает очень тяжело одному, когда вокруг суета,
								проблемы. Но Иисус Христос сделал все, для того, чтобы ты больше
								не оставался один на один с ними. Церковь – это место, где тебя
								принимают любым, молятся за твои проблемы и помогают ближе
								узнать Бога.{' '}
							</p>
							<p className={styles.text}>
								Будем рады видеть тебя на наших Богослужениях каждое воскресенье
								в 10:00, 13:00, 16:00 (для молодежи) по адресу г. Челябинск, ул.
								Красноармейская, 57.
							</p>
						</MotionBox>
					</div>
